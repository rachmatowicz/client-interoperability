...
public class EEInteropCurrent2CurrentITCase {
    ...
    public void testCurrent2CurrentInteroperation() throws Exception {
        System.out.println("EEInteropCurrent2CurrentITCase:testCurrent2CurrentInteroperation (version 2.0.2.Final)");
